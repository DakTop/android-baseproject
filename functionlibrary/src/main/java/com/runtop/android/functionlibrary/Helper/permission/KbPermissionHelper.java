...
/**
 * Description：*/
public class KbPermissionHelper {
    private volatile static KbPermissionHelper instance;

    private KbPermissionHelper() {
    }

    public static KbPermissionHelper getInstance() {
        if (instance == null) {
            synchronized (KbPermissionHelper.class) {
                if (instance == null) {
                    instance = new KbPermissionHelper();
                }
            }
        }
        return instance;
